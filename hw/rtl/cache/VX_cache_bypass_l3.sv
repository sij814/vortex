...
module VX_cache_bypass_l3 #(
    ...
    // Memory request in
    VX_mem_bus_if.slave     mem_bus_in_if [NUM_BANKS],

    // Memory request out
    VX_mem_bus_if.master    mem_bus_out_if [NUM_BANKS]
);
    ...
    wire [NUM_BANKS-1:0]                       mem_req_out_valid;
    wire [NUM_BANKS-1:0]                       mem_req_out_rw;
    wire [NUM_BANKS-1:0][LINE_SIZE-1:0]        mem_req_out_byteen;
    wire [NUM_BANKS-1:0][`CS_MEM_ADDR_WIDTH-1:0] mem_req_out_addr;
    wire [NUM_BANKS-1:0][`ADDR_TYPE_WIDTH-1:0] mem_req_out_atype;
    wire [NUM_BANKS-1:0][`CS_LINE_WIDTH-1:0]   mem_req_out_data;
    wire [NUM_BANKS-1:0][MEM_TAG_OUT_WIDTH-1:0] mem_req_out_tag;
    wire [NUM_BANKS-1:0]                       mem_req_out_ready;
