...
`ifdef DBG_TRACE_CACHE
    ...
    wire [NUM_BANKS-1:0][`UP(UUID_WIDTH)-1:0] mem_req_uuid;
    wire [NUM_BANKS-1:0][`UP(UUID_WIDTH)-1:0] mem_rsp_uuid;
    ...
    wire mem_req_fire [NUM_BANKS-1:0];
    wire mem_rsp_fire [NUM_BANKS-1:0];
